...
module Com.Google.Transit.Realtime.Alert.Cause (Cause(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum Cause where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Com.Google.Transit.Realtime.Alert.Cause") .
      toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Com.Google.Transit.Realtime.Alert.Cause"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Com.Google.Transit.Realtime.Alert.Cause"
...
instance P'.ReflectEnum Cause where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".transit_realtime.Alert.Cause") [] ["Com", "Google", "Transit", "Realtime", "Alert"] "Cause")
      ["Com", "Google", "Transit", "Realtime", "Alert", "Cause.hs"]
