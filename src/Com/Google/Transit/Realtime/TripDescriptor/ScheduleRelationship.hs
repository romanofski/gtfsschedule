...
module Com.Google.Transit.Realtime.TripDescriptor.ScheduleRelationship (ScheduleRelationship(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum ScheduleRelationship where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error
        "hprotoc generated code: toEnum failure for type Com.Google.Transit.Realtime.TripDescriptor.ScheduleRelationship")
      . toMaybe'Enum
  succ SCHEDULED = ADDED
  succ ADDED = UNSCHEDULED
  succ UNSCHEDULED = CANCELED
  succ _
   = Prelude'.error "hprotoc generated code: succ failure for type Com.Google.Transit.Realtime.TripDescriptor.ScheduleRelationship"
  pred ADDED = SCHEDULED
  pred UNSCHEDULED = ADDED
  pred CANCELED = UNSCHEDULED
  pred _
   = Prelude'.error "hprotoc generated code: pred failure for type Com.Google.Transit.Realtime.TripDescriptor.ScheduleRelationship"
...
instance P'.ReflectEnum ScheduleRelationship where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      ...
      ["Com", "Google", "Transit", "Realtime", "TripDescriptor", "ScheduleRelationship.hs"]
