...
module Com.Google.Transit.Realtime.VehiclePosition.OccupancyStatus (OccupancyStatus(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum OccupancyStatus where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error "hprotoc generated code: toEnum failure for type Com.Google.Transit.Realtime.VehiclePosition.OccupancyStatus")
      . toMaybe'Enum
  ...
  succ _
   = Prelude'.error "hprotoc generated code: succ failure for type Com.Google.Transit.Realtime.VehiclePosition.OccupancyStatus"
  ...
  pred _
   = Prelude'.error "hprotoc generated code: pred failure for type Com.Google.Transit.Realtime.VehiclePosition.OccupancyStatus"
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".transit_realtime.VehiclePosition.OccupancyStatus") []
        ...
        "OccupancyStatus")
      ["Com", "Google", "Transit", "Realtime", "VehiclePosition", "OccupancyStatus.hs"]
