...
module Com.Google.Transit.Realtime.VehiclePosition.CongestionLevel (CongestionLevel(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum CongestionLevel where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error "hprotoc generated code: toEnum failure for type Com.Google.Transit.Realtime.VehiclePosition.CongestionLevel")
      . toMaybe'Enum
  ...
  succ _
   = Prelude'.error "hprotoc generated code: succ failure for type Com.Google.Transit.Realtime.VehiclePosition.CongestionLevel"
  ...
  pred _
   = Prelude'.error "hprotoc generated code: pred failure for type Com.Google.Transit.Realtime.VehiclePosition.CongestionLevel"
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".transit_realtime.VehiclePosition.CongestionLevel") []
        ...
        "CongestionLevel")
      ["Com", "Google", "Transit", "Realtime", "VehiclePosition", "CongestionLevel.hs"]
