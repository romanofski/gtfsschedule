...
instance Prelude'.Enum VehicleStopStatus where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error
        "hprotoc generated code: toEnum failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.VehiclePosition.VehicleStopStatus")
      . toMaybe'Enum
  succ INCOMING_AT = STOPPED_AT
  succ STOPPED_AT = IN_TRANSIT_TO
  succ _
   = Prelude'.error
      "hprotoc generated code: succ failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.VehiclePosition.VehicleStopStatus"
  pred STOPPED_AT = INCOMING_AT
  pred IN_TRANSIT_TO = STOPPED_AT
  pred _
   = Prelude'.error
      "hprotoc generated code: pred failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.VehiclePosition.VehicleStopStatus"
...
instance P'.ReflectEnum VehicleStopStatus where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".transit_realtime.VehiclePosition.VehicleStopStatus") ["GTFS", "Realtime", "Internal"]
