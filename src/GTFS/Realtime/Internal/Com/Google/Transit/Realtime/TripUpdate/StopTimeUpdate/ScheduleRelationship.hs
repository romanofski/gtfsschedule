...
module GTFS.Realtime.Internal.Com.Google.Transit.Realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship (ScheduleRelationship(..))
       where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum ScheduleRelationship where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error
        "hprotoc generated code: toEnum failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship")
      . toMaybe'Enum
  succ SCHEDULED = SKIPPED
  succ SKIPPED = NO_DATA
  succ _
   = Prelude'.error
      "hprotoc generated code: succ failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship"
  pred SKIPPED = SCHEDULED
  pred NO_DATA = SKIPPED
  pred _
   = Prelude'.error
      "hprotoc generated code: pred failure for type GTFS.Realtime.Internal.Com.Google.Transit.Realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship"
...
instance P'.ReflectEnum ScheduleRelationship where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".transit_realtime.TripUpdate.StopTimeUpdate.ScheduleRelationship") ["GTFS", "Realtime", "Internal"]
