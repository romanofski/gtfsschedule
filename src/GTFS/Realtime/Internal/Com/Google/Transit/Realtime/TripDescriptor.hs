...
module GTFS.Realtime.Internal.Com.Google.Transit.Realtime.TripDescriptor (TripDescriptor(..)) where
import Prelude ((+), (/), (++), (.), (==), (<=), (&&))
...
instance P'.Default TripDescriptor where
  defaultValue
   = TripDescriptor P'.defaultValue P'.defaultValue P'.defaultValue P'.defaultValue P'.defaultValue
